                    ...
                    <div className="row footer-top-29 mt-md-5 mt-4">
                        <div className="col-lg-4 col-md-6 footer-list-29 footer-1 pe-lg-5">
                            ...
                            <div className="footer-listw3-grids">
                                <p className="pe-lg-4">Lorem ipsum dolor sit amet consectetur ipsum amet elit. Sit amet consectetur ipsum amet, Lorem ipsum dolor sit amet.</p>
                                <div className="w3pt-call-box mt-4">
                                    <div className="w3pt-call-info">
                                        <h5>Get Us Support</h5>
                                        <h5><a href="tel:+1(21) 234 557 456"><i className="fas fa-phone-alt me-1"></i> +1(21) 234 557 456</a></h5>
                                        <h5><a href="mailto:support@mail.com" className="mail"><i className="far fa-envelope me-1"></i> support@mail.com</a></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
